...
export default function AssignTasksTable({ tasksData, handleDeleteTask, handleUpdateTask }: AllTasksProps) {
        ...
        <>
            ...
            <Dialog open={openEditModel} onOpenChange={setOpenEditModel}>
                <DialogContent>
                    ...
                    <form action="" className="flex flex-col gap-4" onSubmit={(e) => {e.preventDefault(); handleUpdateTask(selectedTask, setSelectedTask, setOpenEditModel)}}>
